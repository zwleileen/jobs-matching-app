...
const HomePage = (props) => {
    ...
    <>
        ...
        <SearchResults searchResults={props.searchResults} savedResults={props.savedResults} setSavedResults={props.setSavedResults} loading={props.loading} companyDetails={props.companyDetails} setCompanyDetails={props.setCompanyDetails} />
    </>
    )
}
